...
static const int64 MAX_MONEY = 18000000 * COIN; // ruthenium: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 4) / 250; // ruthenium: Priority cutoff is 2 ruthenium day / 250 bytes.
    }
